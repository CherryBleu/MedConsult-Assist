package com.medconsult.medicalrecord.notification;
...
public class NotificationOutboxProducer {
    ...
    public void enqueueRole(String role, String type, String title, String content,
                            String relatedType, String relatedId) {
        if (role == null || role.isBlank()) {
            return;
        }
        enqueue(role, role, type, title, content, relatedType, relatedId);
    }
