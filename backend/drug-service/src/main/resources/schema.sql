...
-- ============================================================
-- 种子数据（冒烟/演示用；固定主键 5001-5005，供库存流水/库存预警页面演示）
-- ============================================================

-- 药品（主键 5001-5005；drug_no 为业务编号，D + 主键）
INSERT IGNORE INTO drug (id, drug_no, generic_name, trade_name, specification, dosage_form, manufacturer, unit, min_stock_threshold, current_stock, status) VALUES
    ...
    (5004, 'D50004', '硝苯地平缓释片', '拜新同', '20mg*30片',  '缓释片', '拜耳医药保健有限公司', '盒', 80, 12, 'ACTIVE'),
    (5005, 'D50005', '蒙脱石散',       '思密达', '3g*10袋',    '散剂',   '博福-益普生工业公司', '盒', 30, 150, 'ACTIVE');
...
INSERT IGNORE INTO drug_stock_batch (id, drug_id, batch_no, quantity, unit_price, production_date, expire_date, supplier, status) VALUES
    ...
    (6004, 5004, 'BH20260720-LOW',  12, 42.00, '2026-06-20', '2028-01-20', '国药控股股份有限公司', 'AVAILABLE'),
    (6005, 5005, 'BH20260720-EXP', 150, 16.80, '2025-08-20', '2026-08-04', '上海医药集团股份有限公司', 'AVAILABLE');

-- 库存流水（主键 7001-7005；drug_id/batch_id 指向上面主键，记录初始入库）
INSERT IGNORE INTO drug_stock_flow (id, flow_no, drug_id, batch_id, type, quantity, before_quantity, after_quantity, remark, created_at) VALUES
    ...
    (7004, 'SF70004', 5004, 6004, 'INBOUND',  12, 0,  12, '预警演示：低库存入库', NOW()),
    (7005, 'SF70005', 5005, 6005, 'INBOUND', 150, 0, 150, '预警演示：临期批次入库', NOW());
