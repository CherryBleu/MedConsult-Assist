      ...
      <div class="info-card">
        ...
        <el-form label-width="100px" class="info-form">
          ...
          <el-form-item label="账号">
            <span class="info-text">{{ userStore.userInfo.account || '—' }}</span>
          </el-form-item>
...
const roleLabel = computed(() => {
  ...
  if (role === ROLE_ENUM.HOSPITAL_ADMIN.value) return '医院管理员'
  if (role === ROLE_ENUM.PHARMACY_ADMIN.value) return '药房管理员'
  return '管理员'
})
